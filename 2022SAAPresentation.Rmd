...
```{r}
layer_comparison_ml(net, method = "jaccard.edges", mode = "all", layers = c("points","spatial","ceramics","architecture")) %>% knitr::kable()
```
...
```{r}
layer_comparison_ml(net, method = "rho.degree", mode = "all", layers = c("points","spatial","ceramics","architecture")) %>% knitr::kable()
```
...
- Strong architectural correlation
...
- Ceramics 
    - Roomblocks were highly central
- Compounds tended to cluster together
- Platform mounds were often more central
